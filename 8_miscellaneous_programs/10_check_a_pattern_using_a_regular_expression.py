...
- For this program, you need to use a regular expression in Python. The built-in Python
module re has very helpful functions to work with them, such as the search() function.
"""
